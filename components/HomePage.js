...
import { View, SafeAreaView, ScrollView, Text, ActivityIndicator, Pressable } from 'react-native';
        ...
        <View className={"w-full  h-full"}>
          ...
          <View style={{ flex: 1 }} className={'h-[65%] min-h-[300px]'}>
            ...
            <TabView value={index} onChange={setIndex} animationType="spring">
                ...
                <ScrollView>
                  {
                    Data && ProfileData ? Data.map((dat, index) => {
                      return <Question key={dat.id} dat={dat} showbtn={dat.author ===auth.currentUser.uid? false:true} setHomeUpdate={setHomeUpdate} proData={ProfileData} />
              ...
              <TabView.Item style={{ width: '100%' }}>
                <Profile HomeUpdate={HomeUpdate} proData={ProfileData} setHomeUpdate={setHomeUpdate}/>
              </TabView.Item>
            </TabView>
            <Tab
              value={index}
            ...
            >
              <Tab.Item
                ...
                title={"Give Answer"}
                onLongPress={()=>{setHomeUpdate(prev=>!prev)}}
